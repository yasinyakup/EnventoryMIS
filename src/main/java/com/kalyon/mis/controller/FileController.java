...
import com.kalyon.mis.entity.FileInfo;
...
public class FileController {
	...
	public ResponseEntity<ResponseMessage> uploadFilEntity (@RequestParam("file") MultipartFile file){
		
	String message = "";
	
	try {
		fileStorageService.save(file);
		message = "Başarıyla yüklendi: "+file.getOriginalFilename();
		return ResponseEntity.status(HttpStatus.OK).body(new ResponseMessage(message));
		
	} catch (Exception e) {
		message = "Dosya yükleme başarısız: "+ file.getOriginalFilename();
